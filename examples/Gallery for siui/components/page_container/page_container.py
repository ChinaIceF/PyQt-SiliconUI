...
class ExampleContainer(SiPage):
    def __init__(self, *args, **kwargs):
        ...
        with self.titled_widgets_group as group:
            ...
            self.demo_divided_h_container.addSection(width=120, alignment=Qt.AlignLeft)
            self.demo_divided_h_container.addSection(width=180, alignment=Qt.AlignCenter)
            self.demo_divided_h_container.addSection(width=240, alignment=Qt.AlignRight)
            ...
            self.demo_divided_v_container.addSection(height=48, alignment=Qt.AlignTop)
            self.demo_divided_v_container.addSection(height=64, alignment=Qt.AlignVCenter)
            self.demo_divided_v_container.addSection(height=80, alignment=Qt.AlignBottom)
