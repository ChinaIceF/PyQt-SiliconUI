...
class FloatingWindow(QWidget):
    def __init__(self, parent=None):
        ...
        self.tracker_timer.timeout.connect(self.refresh_position)
        self.tracker_timer.start()

        self.resize_animation = SiExpAnimation(self)
        self.resize_animation.setFactor(1/4)
        self.resize_animation.setBias(1)
        self.resize_animation.ticked.connect(self.resize_delta_handler)

        self.transparency_animation = SiExpAnimation(self)
        self.transparency_animation.setFactor(1/4)
        self.transparency_animation.setBias(1)
        self.transparency_animation.ticked.connect(self.transparency_delta_handler)

        self.highlight_animation = SiExpAnimation(self)
        self.highlight_animation.setFactor(1/4)
